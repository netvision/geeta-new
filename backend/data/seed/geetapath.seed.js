/**
 * Seed data derived from geetapath.md
 * Chapters 1–5 of the Geeta Path course.
 */
...
// Content blocks per chapter (chapter_id will be filled at seed-time)
const blocksByChapterNumber = {
  1: [
    {
      type: 'shloka_group',
      order: 1,
    ...
    },
    {
      ...
      content: {
        hi: 'दुर्योधन गुरु द्रोणाचार्य के पास जाकर युद्धभूमि में दोनों पक्षों के योद्धाओं का विवरण देते हैं। क्या द्रोणाचार्य को विपक्ष में खड़े योद्धा नहीं दिख रहे थे? क्‍या वह उनके बल से परिचित नहीं थे? वह यह दिखाता है कि वह जानता है, उसके विपक्ष में कितने बलशाली और आत्मीय लोग हैं और वह यह भी जानता है कि अर्जुन गुरू द्रोणाचार्य का सबसे प्रिय शिष्य है और द्रोणाचार्य ने पहले ही कह दिया था कि वह पाण्डवों को नहीं मारेंगे।',
        en: '',
      },
      metadata: { shloka_refs: [], sanskrit_verses: [], questions: [] },
    },
    {
      type: 'tatparya',
      order: 3,
      section_title: { hi: '', en: '' },
      title: { hi: 'तात्पर्य', en: 'Key Insight' },
      content: {
        hi: 'जीवन में हर परिस्थिति में दो पक्ष होंगे — एक अनुकूल, दूसरा प्रतिकूल। कभी-कभी विपक्ष में आपके अपने प्रिय से प्रिय लोग भी हो सकते हैं और आपको यह निर्णय लेना पड़ेगा कि आप सिद्धान्त को महत्व देकर उनके विरुद्ध खड़े होंगे अथवा सम्बन्ध को महत्व देकर उसके विरुद्ध कोई कदम नहीं उठाएंगे।',
        en: '',
      },
      metadata: { shloka_refs: [], sanskrit_verses: [], questions: [] },
    },
    {
      ...
      order: 4,
      section_title: { hi: '', en: '' },
      title: { hi: 'चर्चा का विषय', en: 'Discussion' },
      content: { hi: '', en: '' },
      metadata: {
        shloka_refs: [],
        sanskrit_verses: [],
    ...
    },
    {
      ...
      order: 7,
      section_title: { hi: '', en: '' },
      title: { hi: 'मनुष्य के जीवन में चिन्ता और शोक का मुख्य कारण', en: 'The Primary Cause of Anxiety and Grief' },
      content: {
        hi: '"जो नहीं है वह मिल जाए और जो है उसका नाश न हो" — अथवा पाने की इच्छा और छूटने का भय — दोनों में ही मूल कारण "चाह" ही है। अर्जुन की भी यही स्थिति थी — वह राज्य चाहता था लेकिन कुटुम्ब का नाश भी नहीं चाहता था।',
        en: '',
      },
      metadata: { shloka_refs: [], sanskrit_verses: [], questions: [] },
    },
  ...
  2: [
    ...
    },
    {
      ...
      order: 2,
      section_title: { hi: '', en: '' },
      title: { hi: 'तीन मुख्य बातें', en: 'Three Key Points' },
      content: {
        hi: '१. परिस्थिति अथवा अनुकूलता और प्रतिकूलता और उनके प्रभाव से होने वाले सुख-दुःख, दोनों अलग-अलग हैं। परिस्थिति में सुख अथवा दुःख दोनों नहीं हैं।\n२. अनुकूलता का स्वरूप — जो चाहते हैं वह हो जाए और जो न चाहते हैं वह न हो।\n३. प्रतिकूलता का स्वरूप — जो चाहते हैं वह न हो और जो न चाहते हों वह हो जाए।',
        en: '',
      },
      metadata: { shloka_refs: [], sanskrit_verses: [], questions: [] },
    },
    ...
    },
    {
      ...
      order: 5,
      section_title: { hi: '', en: '' },
      title: { hi: 'उदाहरण: "यह भी चला जाएगा"', en: 'Example: "This Too Shall Pass"' },
      content: {
        hi: 'बहुत समय पहले की बात है। एक राज्य में एक ज्ञानी और न्यायप्रिय राजा राज करता था। वह अपने राजदरबार में आए दिन बड़े-बड़े विद्वानों और संतों से जीवन के रहस्यों पर चर्चा करता रहता था। एक दिन राजा ने अपने मंत्रियों और दरबारियों से कहा, "मैं ऐसा एक वाक्य चाहता हूं, जो मुझे दुःख में सांत्वना दे और सुख में संयम सिखाए।" कुछ समय बाद एक वृद्ध संत राज्य में आए। राजा ने उनसे भी यही प्रश्न पूछा। संत मुस्कुराए और बोले, "राजन्‌! एक ही वाक्य है जो हर परिस्थिति में सही बैठता है — \'यह भी चला जाएगा।\'" राजा ने उस वाक्य को एक अंगूठी पर खुदवाया। जब राज्य में अकाल पड़ा, उसने अंगूठी देखी — शान्ति मिली। जब खूब सुख-शांति आई — अंगूठी ने याद दिलाया — "यह भी चला जाएगा।" — अहंकार न हुआ।',
        en: '',
      },
      metadata: { shloka_refs: [], sanskrit_verses: [], questions: [], is_parable: true },
    },
    {
      ...
      order: 6,
      section_title: { hi: '', en: '' },
      title: { hi: 'समता ही अमृत है', en: 'Equanimity is Immortality' },
      content: {
        hi: 'जो इनको सहन करने में सक्षम होता है वह मोक्ष — अमृततत्व — के योग्य होता है। समता ही अमृततत्व है। समता वह स्थिति है जहां पर न कूछ पाने की इच्छा रहती है और न कुछ खोने का भय। प्रश्न ये उठता है क्या ये संभव है? बिल्कुल संभव है — एक शर्त — "अचाह" होना पड़ेगा।',
        en: '',
      },
      metadata: { shloka_refs: [], sanskrit_verses: [], questions: [] },
    },
    {
      ...
      order: 7,
      section_title: { hi: '', en: '' },
      title: { hi: 'उदाहरण: अमृत तत्व की खोज', en: 'Example: The Search for Immortality' },
      content: {
        hi: 'एक समय की बात है। एक युवक साधक मोक्ष की खोज में अनेक गुरूओं के पास गया। हर किसी से एक ही प्रश्न पूछता — "गुरुदेव, अमृत तत्व कहां है?" आखिरकार वह एक शांत पर्वत पर रहने वाले मौन साधु के पास पहुंचा। साधु ने उसे दो चिट्ठियां दीं — एक पर राजा का सम्मान, दूसरी पर गांव से अपमान। पहले दिन राजसभा में स्वागत हुआ; अगले दिन अपमान कर बाहर निकाला गया। युवक रोते हुए साधु के पास लौटा। साधु ने कहा — "बेटा, अमृत तत्व कोई बाहर की चीज नहीं है। वह तो तेरे भीतर तब प्रकट होती है जब तू इन सब में एक सा रहना सीख जाए — न मान में फूल, न अपमान में टूट। जब तू सुख-दुःख, हार-जीत, लाभ-हानि में समान रह सकेगा — वही समता है और वही अमृत है।"',
        en: '',
      },
      metadata: { shloka_refs: [], sanskrit_verses: [], questions: [], is_parable: true },
    },
  ...
  3: [
    ...
    },
    {
      ...
      order: 3,
      section_title: { hi: '', en: '' },
      title: { hi: 'उदाहरण', en: 'Examples' },
      content: {
        hi: '१. गंगाजी में जल निरन्तर बहता है — कभी स्वच्छ, कभी मैला — उसका स्वरूप एक सा नहीं होता। लेकिन जो नीचे आधारशिला है वह वैसी की वैसी रहती है — उसमें कोई परिवर्तन नहीं होता।\n\n२. बचपन में जवानी और बुढ़ापा नहीं होता; जवानी में बचपन और बुढ़ापा नहीं होता; बुढ़ापे में बचपन और जवानी नहीं होती। लेकिन ऐसा कोई नहीं कहता कि हम तीनों अवस्था में नहीं हैं। तीनों अवस्थाऐं बदल रही हैं और हम तीनों में ही निरन्तर हैं — अर्थात अवस्था के बदलने से हमारे में कोई बदलाव नहीं हुआ।',
        en: '',
      },
      metadata: { shloka_refs: [], sanskrit_verses: [], questions: [] },
    },
  ...
  4: [
    ...
    },
    {
      ...
      order: 3,
      section_title: { hi: '', en: '' },
      title: { hi: 'समता का महत्व', en: 'The Importance of Equanimity' },
      content: {
        hi: 'थोड़ा सा भी त्याग (समता की स्थिति) बड़ी से बड़ी भौतिक उन्नत्ति से ज्यादा महत्त्वपूर्ण है, क्योंकि वह नित्य है — जितनी समता आ गई वह नष्ट नहीं होगी। और बड़ी से बड़ी उपलब्धि भी अगर मनुष्य प्राप्त कर ले तो भी वह रहेगी नहीं — अनित्य है। समता थोड़ी भी पूरी है और बड़ी से बड़ी उपलब्धि पूरी भी अधूरी है।',
        en: '',
      },
      metadata: { shloka_refs: [], sanskrit_verses: [], questions: [] },
    },
  ...
  5: [
    ...
    },
    {
      ...
      order: 2,
      section_title: { hi: '', en: '' },
      title: { hi: 'कर्मयोग के चार सिद्धान्त', en: 'Four Principles of Karma Yoga' },
      content: {
        hi: '१. तेरा केवल कर्म करने में ही अधिकार है — अर्थात्‌ करने योग्य कर्म को करना और न करने योग्य कर्म को न करना। इसमें ज्यादा महत्वपूर्ण है "न करने योग्य कर्म को न करना।"\n\n२. तेरा फल पर कोई अधिकार नहीं — अर्थात्‌ फल परिस्थिति (अनुकूलता-प्रतिकूलता) के रूप में ही आता है। परिस्थिति के ऊपर मनुष्य का कोई नियंत्रण नहीं है।\n\n३. तेरे कर्म करने की प्रवृत्ति में हेतु फल न हो — अर्थात परिस्थिति बदलने अथवा बनाए रखने के उद्देश्य से कर्म न करें।\n\n४. तेरी कर्म न करने में भी अनासक्ति न हो — अर्थात्‌ यह भाव न हो कि जब मुझे कुछ मिलना ही नहीं है तो मैं कर्म क्यों करूं।',
        en: '',
      },
      metadata: { shloka_refs: [], sanskrit_verses: [], questions: [] },
    },
    {
      ...
      order: 3,
      section_title: { hi: '', en: '' },
      title: { hi: 'मूल मंत्र: अपने अधिकार का त्याग और दूसरे के अधिकार की रक्षा', en: 'Core Principle: Renounce Self-Will; Protect Others\' Rights' },
      content: {
        hi: 'जब उद्देश्य परिस्थिति से हटकर समता की ओर परिवर्तित होता है तब मनुष्य साधनशील हो जाता है और इस बात को स्वीकार करता है कि अपनी "चाह" अथवा अपना "संकल्प" ही मूल बाधा है।\n\nइसका एक ही उपाय है कि अपने संकल्प का त्याग करके दूसरे के संकल्प की पूर्ति के लिए ही कर्म में प्रवृत होना चाहिए।\n\nमूल मंत्र — "अपने अधिकार का त्याग और दूसरे के अधिकार की रक्षा।"\n\n"दूसरा" कौन? जो भी आपके परिवार के न्यूक्लियर सदस्य हैं — माता-पिता, भाई-बहन इत्यादि — उनके संकल्प की पूर्ति। दो बातों का ध्यान — पहला कोई विवेक विरुद्ध मांग न हो और दूसरा अपने सामर्थ्य के बाहर बात न हो।\n\nकर्म करने के दो स्तर हैं — शारीरिक और मानसिक। दोनों ही स्तरों से किसी का कोई अहित नहीं होना चाहिए।',
        en: '',
      },
      metadata: { shloka_refs: [], sanskrit_verses: [], questions: [] },
    },
    {
      ...
      order: 4,
      section_title: { hi: '', en: '' },
      title: { hi: 'करने योग्य और न करने योग्य', en: 'What to Do and What Not to Do' },
      content: {
        hi: 'प्रायः मनुष्य वही कर्म करता है अथवा नहीं करता है जो उसे अच्छा लगता है या बुरा लगता है। अर्थात्‌ उसको जो कर्म करने में मजा आता है उसको वह सही मानता है।\n\nअब दृष्टि सुख से हटकर सिद्धान्त (करने योग्य अथवा न करने योग्य) पर रखनी चाहिए।\n\nकरने योग्य क्‍या है और न करने योग्य क्या है — इसका बड़ा सरल उत्तर है कि जो (हमें बुरा लगता है वह हम दूसरे के साथ न करें) — और करने अथवा न करने में तथा इसके परिणाम में जो भी परिस्थिति आए उसमें सम रहें।',
        en: '',
      },
      metadata: { shloka_refs: [], sanskrit_verses: [], questions: [] },
    },
...
module.exports = { chapters, blocksByChapterNumber };
